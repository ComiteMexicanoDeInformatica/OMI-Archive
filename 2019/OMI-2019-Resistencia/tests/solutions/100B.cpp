/*
Esta solución requiere un trabajo manual con la salida, ya que encuentra números
de persistencia 10, pero para conseguir uno de persistencia 11 es cosa de
agarrar uno de los de persistencia 10, factorizarlo (queda 2^19 * 3^4 * 7^ 6) y
luego encontrar cómo agrupar los dígitos para que den ese producto, la mejor
manera es 277777788888899
*/
#include <bits/stdc++.h>
...
class BigNum {
 public:
  ...
  bool operator<(ll b) const { return *this < BigNum(b); }
